...
export const API_ROUTES = {
  ...
  users: {
    ...
    sendFriendRequest: (id: number) => `/api/users/${id}/friend-requests`,
    cancelFriendRequest: (id: number) => `/api/users/${id}/friend-requests`,
    acceptFriendRequest: (id: number) => `/api/users/friend-requests/${id}/accept`,
    rejectFriendRequest: (id: number) => `/api/users/friend-requests/${id}/reject`,
    incomingFriendRequests: '/api/users/friend-requests/incoming',
    outgoingFriendRequests: '/api/users/friend-requests/outgoing',
    friends: (id: number) => `/api/users/${id}/friends`,
    friendshipStatus: (id: number) => `/api/users/${id}/friendship-status`,
